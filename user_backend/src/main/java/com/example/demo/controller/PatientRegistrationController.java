...
//    }
//    
//    @GetMapping("/patientregister/email/{email}")
//    public ResponseEntity<PatientRegistration> getByEmail(@PathVariable(value = "email") String email)
//        throws ResourceNotFoundException {
//    	return patientRegistrationService.getEnquiryByEmail(email);
//    }
//}